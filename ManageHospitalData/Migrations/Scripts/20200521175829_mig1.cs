        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sexe = table.Column<string>(nullable: true),
                    ContactId = table.Column<Guid>(nullable: true),
                    DoctorCategoryId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: true),
                    MaxCreadit = table.Column<decimal>(nullable: true),
                    CustomerCategoryId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_DoctorCategories_CustomerCategoryId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("252161ac-17da-453e-894c-b993c0d21925"), "Admin", "Company" });
