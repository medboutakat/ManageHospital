...
namespace  ManageHospitalApi.Controllers
{
    ...
    public class HospitalCategoryController : ControllerBase
    {
        ...
        [HttpGet]
        public IEnumerable<HospitalCategoryModel> GetAll()
        {
        ...
        [HttpPut("{Id}")]
        public async Task<IActionResult> Edit([FromRoute] Guid Id, [FromBody] HospitalCategoryModel obj)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
        ...
        [HttpPost]
        public async Task<IActionResult> Add([FromBody] HospitalCategory obj)
        {
